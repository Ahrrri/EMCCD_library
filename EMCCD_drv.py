"""
Andor SDK 2 uses its own driver codes, each of which is the return value of almost every function.
With these driver codes you can know whether the function call was successful or not.
This file is based on Andor SDK 2 version 2.102
...
drv_to_int = dict()
int_to_drv = dict()
for drv, code_num in vars().copy().items():
	if drv.startswith("DRV_"):
		drv_to_int[drv] = code_num
		int_to_drv[code_num] = drv
